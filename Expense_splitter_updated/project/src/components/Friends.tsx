      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {friends.length === 0 && (
          <div className="col-span-full text-center py-12">
            ...
            <button
              onClick={onAddFriend}
              className="bg-gradient-to-r from-emerald-500 to-green-600 text-white px-6 py-2 rounded-lg hover:from-emerald-600 hover:to-green-700 transition-all duration-200"
            >
